...
async function seed() {
  ...
  /*Admin*/await User.create({firstName: "Cristian", lastName: "Mendoza", email: "cristian@gmail.com", password: "1", address: "Aston 1311", phone: "43432432", userType: "2", }).then(() => console.log("Generando super usuario con telemetría cósmica")).catch((err) => console.log(err));
  /*User*/await User.create({firstName: "Jose", lastName: "Perez", email: "jose@gmail.com", password: "1", address: "Machacay 8042", phone: "7522432", userType: "1", }).then(() => console.log("Fusión molecular completada, por favor espere...")).catch((err) => console.log(err));
    console.log("users generated!");

    Category.bulkCreate([{name: "calzado"}, {name: "informal"}, {name: "formal"}, {name: "verano"}, {name: "invierno"}]).then(() => console.log("categories generated!")).catch((err) => console.log(err));
    ...
    ]).then(() => console.log("orders generated!")).catch((err) => console.log(err));
  }
